...
import de.bluplayz.util.LocaleFile;
...
public class Locale {
     ...
     */
    public void addTranslations(HashMap<String, String> translations) {
     ...
     */
    public void addTranslations(HashMap<String, String> translations, boolean replace) {
        if (getLocaleFile() == null) {
            return;
        }
